...
<head>
  ...
  <link rel="stylesheet" href="https://use.typekit.net/whw0uxn.css">
    <?php wp_head(); ?>
</head>
    ...
    <div class="site-branding col-6">
      ...
      if ( is_front_page() || is_home() ) : ?>
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
            <img src="<?php echo get_template_directory_uri(); ?>/static/img/logo.svg" data-skip-lazy alt="<?php bloginfo( 'name' ); ?>">
          </a>
      <?php else : ?>
          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
            <img src="<?php echo get_template_directory_uri(); ?>/static/img/logo.svg" data-skip-lazy alt="<?php bloginfo( 'name' ); ?>">
